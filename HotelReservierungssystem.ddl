CREATE TABLE Owner (ownerId INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, addressId integer(10) NOT NULL, name varchar(50), surname varchar(50), company varchar(50) NOT NULL);
...
CREATE TABLE Hotel (hotelId INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, "Owner ownerId" integer(10) NOT NULL, addressId integer(10) NOT NULL, name varchar(50) NOT NULL, stars integer(1), type varchar(30) NOT NULL, isAccessible blob, numberRooms integer(5) NOT NULL, numberFloors integer(5) NOT NULL, constructionYear integer(4) NOT NULL, capacity integer(4) NOT NULL, employees integer(10) NOT NULL, operatingMode varchar(20) NOT NULL, FOREIGN KEY("Owner ownerId") REFERENCES "Owner "(ownerId), FOREIGN KEY(addressId) REFERENCES Address(addressId));
...
CREATE TABLE "Pension type" (pensionTypeId INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, type varchar(50) NOT NULL);
...
CREATE TABLE "Bill Articles" (articleId INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, description varchar(20) NOT NULL, amount numeric(10, 2) NOT NULL);
...
CREATE TABLE "Bill_Bill Articles" (billId integer(10) NOT NULL, articleId integer(10) NOT NULL, PRIMARY KEY (billId, articleId), FOREIGN KEY(billId) REFERENCES Bill(billId), FOREIGN KEY(articleId) REFERENCES "Bill Articles"(articleId));
CREATE TABLE "Hotel_Pension type" (HotelhotelId integer(10) NOT NULL, "Pension typepensionTypeId" integer(10) NOT NULL, PRIMARY KEY (HotelhotelId, "Pension typepensionTypeId"), FOREIGN KEY(HotelhotelId) REFERENCES Hotel(hotelId), FOREIGN KEY("Pension typepensionTypeId") REFERENCES "Pension type"(pensionTypeId));
...
CREATE UNIQUE INDEX "Pension type_pensionTypeId" ON "Pension type" (pensionTypeId);
...
CREATE UNIQUE INDEX "Bill Articles_articleId" ON "Bill Articles" (articleId);
...
INSERT INTO Hotel(hotelId, "Owner ownerId", addressId, name, stars, type, isAccessible, numberRooms, numberFloors, constructionYear, capacity, employees, operatingMode) VALUES (1, 1, 2, 'Alpenblick', 4, 'Hotel', 1, 50, 4, 1990, 100, 40, 'Ganzjährig');
...
INSERT INTO "Pension type"(pensionTypeId, type) VALUES (1, 'Vollpension');
...
INSERT INTO "Bill Articles"(articleId, description, amount) VALUES (1, 'Ski Pass', 200);
INSERT INTO "Bill Articles"(articleId, description, amount) VALUES (2, 'Getränk', 10);
INSERT INTO "Bill Articles"(articleId, description, amount) VALUES (3, 'Tresor', 30);
...
INSERT INTO "Bill_Bill Articles"(billId, articleId) VALUES (1, 1);
INSERT INTO "Hotel_Pension type"(HotelhotelId, "Pension typepensionTypeId") VALUES (1, 1);
